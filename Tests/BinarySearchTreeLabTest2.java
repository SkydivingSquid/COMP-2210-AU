public class BinarySearchTreeLabTest2 {
   public static void main(String[] args) {
      BinarySearchTree2 < Integer > iBst = new BinarySearchTree2 < > ();
      iBst.add(10);
      iBst.add(12);
      iBst.add(8);
      iBst.add(2);
      ...
      BinarySearchTree2 < String > sBst = new BinarySearchTree2 < > ();
      sBst.add("W");
      sBst.add("A");
      sBst.add("R");
      sBst.add("E");
   ...
   static class BinarySearchTree2 < T extends Comparable < T >> {
